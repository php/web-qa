...
<center>
<h2>PHP Build and Install Tracker</h2>
...
<tr bgcolor="#E0E0E0">
		...
		<table width="100%">
			...
			<tr bgcolor="#F0F0F0">
				<td><font face="Tahoma, Arial, Helvetica, sans-serif">
				&nbsp;<b>3.2.2</b> Web Server
				</font>
				</td>

				<td align="center"><font face="Tahoma, Arial, Helvetica, sans-serif">
				<input type="text" name="field[server_name_two]" value="<?= $field[server_name_two] ?>" size="32" maxlength="56" />
				</font></td>

				<td align="center"><font face="Tahoma, Arial, Helvetica, sans-serif">
				<input type="text" name="field[server_version_two]" value="<?= $field[server_version_two] ?>" size="7" maxlength="28" />
				</font>
				</td>
			</tr>
