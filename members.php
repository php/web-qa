...
?>
    ...
    <ul>
      <li><b>Jalal Pushman</b> &lt;<a href="mailto:the_jalal@yahoo.com">the_jalal@yahoo.com</a>&gt;
        <ul>
    ...
    <ul>
      <li><b>Jani Taskinen</b> &lt;<a href="mailto:sniper@php.net">sniper@php.net</a>&gt;
        <ul>
          <li>Skills: Linux, Solaris (sparc), PHP, MySQL, LDAP, some C, some Perl</li>
    ...
    <h2>PHP|QAT Supporting Members</h2>
...
sysvsem, sysvshm, wddx, zlib</li>
    ...
    <h2>PHP|QAT Inactive Members</h2>
    <ul>
      <li>Alexander Feldman</li>
      <li>Andreas Otto</li>
      <li>Evan Klein</li>
      <li>Karl Austin</li>
      <li>Mårten Gustafson</li>
      <li>Patrik Bengtsson</li>
      <li>Rebecca "Bean" Visger</li>
      <li>Shawn Wallace</li>
    </ul>
