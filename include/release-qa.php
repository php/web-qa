...
$BUILD_TEST_RELEASES = array('5.3.3RC3', '5.2.14RC3');
$DEV_RELEASES = array();
...
$CURRENT_QA_RELEASE_52 = '5.2.14RC3'; // IMPORTANT: Fix URLs below for next release!
$RC_FILES_52 = array (
	array (
...
/* PHP 5 Releases */
$CURRENT_QA_RELEASE_5 = '5.3.3RC3'; // true
$RC_FILES_5 = array (
	array (
		'http://downloads.php.net/johannes/',
