...
//
// reports are stored as flat-files in pftt-reports/$branch/$revision (this is just a simple file upload script)
//
//
...
// ensure dir exists
//mkdir($report_dir, 0666, TRUE);
$a = "";
$b = explode("/", $report_dir);
var_dump($b);
foreach ($b as $c) {
    $a .= "/" . $c;
    var_dump($a);
